"""
Table sorting JavaScript code
Originally from sortable.js by Joost de Valk
Based on a script from http://www.kryogenix.org/code/browser/sorttable/
Distributed under the MIT license

This module provides the JavaScript code as a Python string constant
for embedding into HTML pages generated by gitstats.
"""
...
def get_sortable_js():
    """
    Returns the sortable JavaScript code as a string.
    This can be embedded directly into HTML pages.
    """
    return SORTABLE_JS_CODE
